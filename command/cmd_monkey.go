...
type cmdMonkey struct {
	ConsoleInterface
}

func init() {
	var command ConsoleInterface
	command = new(cmdMonkey)
	commandList[command.GetSignature()] = command
}

func (cmdMonkey cmdMonkey) GetSignature() string {
	return "cmdMonkey"
}

func (cmdMonkey cmdMonkey) GetDescription() string {
	return "this is a Description"
}

func (cmdMonkey cmdMonkey) Handle() {
